   ...
   <div>
    <Container>
      ...
      <Row className="text-center">     
        <img id="drygon-card" src={drygonCard} alt="drygon card" className="img-fluid mx-auto"/>     
      </Row>
      <p>Now DRYGON has matured into the current logo depicting a stylized design incorporating both a powerful dragon with the mythical phoenix. <img id="drygon" alt={logo} src={logo} className="img-thumnail"/></p>
    </Container>
</div>
);
